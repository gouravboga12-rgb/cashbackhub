...
const initialData = {
  ...
  users: [
    {
      ...
      mobile: '+919876543210',
      password_hash: '$2a$10$e8W/kI1a3Rj8z/X3/U9X7.P8wYwTq2jA2RkY.Yy.Xz4J8wYwTq2jA', // bcrypt for Demo123!
      role: 'user',
  ...
  ad_completions: [],
  spin_configurations: [
    { id: 'slice_1', label: '1000 Points', reward_points: 1000, probability_weight: 5, color: '#5B21B6' },
    { id: 'slice_2', label: '500 Points', reward_points: 500, probability_weight: 15, color: '#4ADE80' },
    { id: 'slice_3', label: '200 Points', reward_points: 200, probability_weight: 25, color: '#6D28D9' },
    { id: 'slice_4', label: '50 Points', reward_points: 50, probability_weight: 25, color: '#22C55E' },
    { id: 'slice_5', label: '50 Points', reward_points: 50, probability_weight: 20, color: '#7C3AED' },
    { id: 'slice_6', label: 'Better Luck Next Time', reward_points: 0, probability_weight: 10, color: '#EC4899' }
  ],
  spin_history: [],
  vouchers: [
    {
    ...
    },
    {
      ...
      provider: 'Amazon',
      description: 'Add money directly to your Amazon Pay wallet balance.',
      logo: '📦',
      minimum_points: 1000,
  ...
  notifications: [
    {
      id: 'notif_1',
      user_id: 'usr_demo_101',
      title: 'Welcome to CashBack Hub! 🎉',
      message: 'Start marking daily attendance to earn your first +10 points today.',
      type: 'reward',
      is_read: false,
      created_at: new Date().toISOString()
    }
